...
Sum the share (%) of all delivery tiers with fulfillment days GREATER than 14 days. This gives you the "% of orders outside 14 days". Then select the reason code:
